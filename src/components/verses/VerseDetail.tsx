...
export function VerseDetail({ verse, language, onRestrictedAction, onLoginRequired }: VerseDetailProps) {
    ...
    const [targetLoops, setTargetLoops] = useState(10);
    ...
    const startRecording = async () => {
        try {
            ...
            const mediaRecorder = new MediaRecorder(stream, { mimeType, audioBitsPerSecond: 24000 });
                ...
                {practiceStep === 2 && (
                    <div className="flex flex-col items-center gap-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            {stepDone[2] && (
                                <button
                                    onClick={() => { setPracticeStep(3); setLoopCount(0); setIsPlaying(false); }}
