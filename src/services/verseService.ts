...
const MOCK_VERSES: Verse[] = [
    {
        ...
        seriesId: "series-1",
        order: 1,
        reference: { en: "Philippians 4:6-7", ko: "빌립보서 4:6-7", zh: "Philippians 4:6-7", es: "Philippians 4:6-7" },
        text: {
    ...
    },
    {
        ...
        seriesId: "series-1",
        order: 2,
        reference: { en: "Isaiah 41:10", ko: "이사야 41:10", zh: "Isaiah 41:10", es: "Isaiah 41:10" },
        text: {
